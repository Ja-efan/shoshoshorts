...
//    private final String defaultVoiceCode = "uyVNoMrnUku1dZyVEXwD";
    ...
    //전체 오디오 생성
    public SceneDocument generateSceneAudio(String storyId, int sceneId) {
        log.info("씬 오디오 생성 시작: storyId={}, sceneId={}", storyId, sceneId);
        ...
        // 해당 씬 찾기
        Map<String, Object> targetScene = findSceneAndAudio(sceneDocument, sceneId, null);

        // 해당 씬의 오디오 배열에 대해 반복 처리
        ...
        log.info("씬 오디오 생성 완료: storyId={}, sceneId={}", storyId, sceneId);
